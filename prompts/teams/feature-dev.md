...
1. Your role: ${WORKFLOW_DIR}/prompts/agents/feature-dev/lead.md
2. Coder role: ${WORKFLOW_DIR}/prompts/agents/feature-dev/coder.md
3. Reviewer role: ${WORKFLOW_DIR}/prompts/agents/feature-dev/reviewer.md
