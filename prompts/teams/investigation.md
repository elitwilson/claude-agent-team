...
1. Your role: ${WORKFLOW_DIR}/prompts/roles/investigation/coordinator.md
2. Investigator role: ${WORKFLOW_DIR}/prompts/roles/investigation/investigator.md
...
- The full contents of ${WORKFLOW_DIR}/prompts/roles/investigation/investigator.md
