...
1. Your role: ${WORKFLOW_DIR}/prompts/roles/solo-with-subagent-review/solo-dev.md
2. Reviewer role: ${WORKFLOW_DIR}/prompts/roles/solo-with-subagent-review/reviewer.md
...
- The full contents of ${WORKFLOW_DIR}/prompts/roles/solo-with-subagent-review/reviewer.md
