...
- [ ] Read `docs/specs/<slug>-decisions.md` — verify every assumption the agent made
- [ ] Read `docs/specs/<slug>-review-notes.md` — scrutinize any tasks the Reviewer flagged
